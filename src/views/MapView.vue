<template>
  <div @click="clickedLine = ''">
    <svg width="14in" height="8.5in" version="1.1" viewBox="0 0 355.6 215.9" xmlns="http://www.w3.org/2000/svg">
      <rect id="Line01" v-bind:class="lines[0]" @click="setModalVars(linesArr[0])" x="61.427" y="22.065" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line04" v-bind:class="lines[3]" @click="setModalVars(linesArr[3])" x="61.427" y="88.17" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line07" v-bind:class="lines[6]" @click="setModalVars(linesArr[6])" x="61.427" y="154.28" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line02" v-bind:class="lines[1]" @click="setModalVars(linesArr[1])" x="158.27" y="22.065" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line05" v-bind:class="lines[4]" @click="setModalVars(linesArr[4])" x="158.27" y="88.17" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line08" v-bind:class="lines[7]" @click="setModalVars(linesArr[7])" x="158.27" y="154.28" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line03" v-bind:class="lines[2]" @click="setModalVars(linesArr[2])" x="255.11" y="22.065" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line06" v-bind:class="lines[5]" @click="setModalVars(linesArr[5])" x="255.11" y="88.17" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
      ...
      <rect id="Line09" v-bind:class="lines[8]" @click="setModalVars(linesArr[8])" x="255.11" y="154.28" width="47.892" height="32.523" fill-opacity="100" stroke="#000" stroke-linejoin="round" stroke-width=".52917"/>
    ...
    <div>
      <line-options-modal v-show="showModal" v-bind:line="modalLine"
      v-bind:lineDown="modalLineIsDown" v-bind:employee="modalEmployee" @close-modal="closeLineOptionsModal" />
    </div>
  </div>
</template>
